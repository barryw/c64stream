...
| ntsc_palette_follow_device   | NTSC   | Default        | video_quality, audio, palette_mapping (mock emits runtime palette) |
| ntsc_palette_follow_device_unsup | NTSC | Default      | video_quality, audio, palette_mapping (mock rejects palette=1)     |
